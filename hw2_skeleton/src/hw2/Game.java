...
public class Game
{
  ...
  /**
   * the method name describes its use
   * 
   * honestly though it just edits a single cell which is the one generate
   * makes
   * @param gameGrid
   * 	the grid with the cell to be edited
   * @param tile
   * 	the TilePosition generated by the method generate and nothing was done
   * 	with because it was told so
   */
